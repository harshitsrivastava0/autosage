...
export default function AdvisorError({ reset }: { error: Error; reset: () => void }) {
  return (
    <div className="flex flex-col items-center justify-center min-h-[60vh] gap-6 px-4 text-center">
      ...
      <div>
        <h2 className="text-lg font-bold text-brand-navy mb-2">Advisor error</h2>
        <p className="text-sm text-gray-500">Something went wrong with the advisor. Your answers are safe.</p>
      </div>
      <button
        onClick={reset}
